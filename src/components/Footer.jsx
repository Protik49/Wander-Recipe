...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-horizontal footer-center bg-[#0F1728] text-primary-content p-10">
        <aside>
          <svg
          ...
          <p className="font-semibold text-xl text-[#9EA6AC]">
            Bill Man 24 Ltd.
            <br />
            <span className="font-normal text-sm text-[#9EA6AC]">
              Providing reliable bill management since 2022
            </span>
          </p>
          <p className="text-sm text-[#9EA6AC]">
